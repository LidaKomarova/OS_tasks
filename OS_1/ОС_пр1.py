...
def info():
    ...
    print("Имя тома: ", s[0], "\n", "Серийный номер тома: ", s[1], "\n", "Название файловой системы: ", s[-1], sep='')
    print("Размер файловой системы: ", os.path.getsize(os.getenv("SystemDrive")), "\n")
    ...
    if choose == 4:
        ...
        def xml_choose():
            ...
            try:
                ...
                main() if choose2 == 5 else None
                if choose2 == 3:
                    new_data = input("Введите строчку(Например: [<investor>investor_10</investor>]): ")
